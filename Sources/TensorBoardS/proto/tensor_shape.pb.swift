...
// Source: proto/tensor_shape.proto
//
...
struct TensorBoardS_TensorShapeProto {
  ...
  var dim: [TensorBoardS_TensorShapeProto.Dim] = []
...
extension TensorBoardS_TensorShapeProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TensorBoardS_TensorShapeProto, rhs: TensorBoardS_TensorShapeProto) -> Bool {
...
extension TensorBoardS_TensorShapeProto.Dim: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = TensorBoardS_TensorShapeProto.protoMessageName + ".Dim"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "size"),
    2: .same(proto: "name"),
  ]
  ...
  static func ==(lhs: TensorBoardS_TensorShapeProto.Dim, rhs: TensorBoardS_TensorShapeProto.Dim) -> Bool {
