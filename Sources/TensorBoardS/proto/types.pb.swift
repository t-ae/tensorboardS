...
/// LINT.IfChange
enum TensorBoardS_DataType: SwiftProtobuf.Enum {
...
extension TensorBoardS_DataType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [TensorBoardS_DataType] = [
    .dtInvalid,
    .dtFloat,
    .dtDouble,
    .dtInt32,
...
extension TensorBoardS_DataType: SwiftProtobuf._ProtoNameProviding {
