...
struct TensorBoardS_Event {
  ...
  var summary: TensorBoardS_Summary {
    get {
      if case .summary(let v)? = _storage._what {return v}
      return TensorBoardS_Summary()
    }
  ...
  enum OneOf_What: Equatable {
    ...
    case graphDef(Data)
    /// A summary was generated.
    case summary(TensorBoardS_Summary)
    /// The user output a log message. Not all messages are logged, only ones
    /// generated via the Python tensorboard_logging module.
    case logMessage(TensorBoardS_LogMessage)
    /// The state of the session which can be used for restarting after crashes.
    case sessionLog(TensorBoardS_SessionLog)
    /// The metadata returned by running a session.run() call.
    case taggedRunMetadata(TensorBoardS_TaggedRunMetadata)
    /// An encoded version of a MetaGraphDef.
    case metaGraphDef(Data)

  #if !swift(>=4.1)
    static func ==(lhs: TensorBoardS_Event.OneOf_What, rhs: TensorBoardS_Event.OneOf_What) -> Bool {
      switch (lhs, rhs) {
...
struct TensorBoardS_LogMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var level: TensorBoardS_LogMessage.Level = .unknown
...
extension TensorBoardS_LogMessage.Level: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [TensorBoardS_LogMessage.Level] = [
    .unknown,
    .debug,
    .info,
    .warn,
...
struct TensorBoardS_SessionLog {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var status: TensorBoardS_SessionLog.SessionStatus = .statusUnspecified
...
extension TensorBoardS_SessionLog.SessionStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [TensorBoardS_SessionLog.SessionStatus] = [
    .statusUnspecified,
    .start,
    .stop,
    .checkpoint,
...
struct TensorBoardS_TaggedRunMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TensorBoardS_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _step: Int64 = 0
    var _what: TensorBoardS_Event.OneOf_What?
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 8:
          var v: TensorBoardS_TaggedRunMetadata?
          if let current = _storage._what {
            try decoder.handleConflictingOneOf()
  ...
  static func ==(lhs: TensorBoardS_Event, rhs: TensorBoardS_Event) -> Bool {
...
extension TensorBoardS_LogMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TensorBoardS_LogMessage, rhs: TensorBoardS_LogMessage) -> Bool {
...
extension TensorBoardS_LogMessage.Level: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension TensorBoardS_SessionLog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TensorBoardS_SessionLog, rhs: TensorBoardS_SessionLog) -> Bool {
...
extension TensorBoardS_SessionLog.SessionStatus: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension TensorBoardS_TaggedRunMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TensorBoardS_TaggedRunMetadata, rhs: TensorBoardS_TaggedRunMetadata) -> Bool {
