...
// Source: proto/resource_handle.proto
//
...
/// a single run.
struct TensorBoardS_ResourceHandleProto {
...
extension TensorBoardS_ResourceHandleProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TensorBoardS_ResourceHandleProto, rhs: TensorBoardS_ResourceHandleProto) -> Bool {
