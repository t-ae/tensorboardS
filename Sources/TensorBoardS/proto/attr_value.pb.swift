...
struct TensorBoardS_AttrValue {
  ...
  /// "type"
  var type: TensorBoardS_DataType {
    get {
  ...
  /// "shape"
  var shape: TensorBoardS_TensorShapeProto {
    get {
      if case .shape(let v)? = _storage._value {return v}
      return TensorBoardS_TensorShapeProto()
    }
  ...
  /// any "list(...)"
  var list: TensorBoardS_AttrValue.ListValue {
    get {
      if case .list(let v)? = _storage._value {return v}
      return TensorBoardS_AttrValue.ListValue()
    }
  ...
  var `func`: TensorBoardS_NameAttrList {
    get {
      if case .func(let v)? = _storage._value {return v}
      return TensorBoardS_NameAttrList()
    }
  ...
  enum OneOf_Value: Equatable {
    ...
    case b(Bool)
    /// "type"
    case type(TensorBoardS_DataType)
    /// "shape"
    case shape(TensorBoardS_TensorShapeProto)
    /// "tensor"
    case tensor(TensorBoardS_TensorProto)
    /// any "list(...)"
    case list(TensorBoardS_AttrValue.ListValue)
    /// "func" represents a function. func.name is a function's name or
    /// a primitive op's name. func.attr.first is the name of an attr
    /// defined for that function. func.attr.second is the value for
    /// that attr in the instantiation.
    case `func`(TensorBoardS_NameAttrList)
    /// This is a placeholder only used in nodes defined inside a
    /// function.  It indicates the attr value will be supplied when
    /// the function is instantiated.  For example, let us suppose a
    /// node "N" in function "FN". "N" has an attr "A" with value
  ...
  #if !swift(>=4.1)
    static func ==(lhs: TensorBoardS_AttrValue.OneOf_Value, rhs: TensorBoardS_AttrValue.OneOf_Value) -> Bool {
      switch (lhs, rhs) {
...
struct TensorBoardS_NameAttrList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TensorBoardS_AttrValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _value: TensorBoardS_AttrValue.OneOf_Value?
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1:
          var v: TensorBoardS_AttrValue.ListValue?
        ...
        case 6:
          if _storage._value != nil {try decoder.handleConflictingOneOf()}
          var v: TensorBoardS_DataType?
          try decoder.decodeSingularEnumField(value: &v)
          if let v = v {_storage._value = .type(v)}
        case 7:
          var v: TensorBoardS_TensorShapeProto?
          if let current = _storage._value {
            try decoder.handleConflictingOneOf()
        ...
        case 10:
          var v: TensorBoardS_NameAttrList?
          if let current = _storage._value {
            try decoder.handleConflictingOneOf()
  ...
  static func ==(lhs: TensorBoardS_AttrValue, rhs: TensorBoardS_AttrValue) -> Bool {
...
extension TensorBoardS_AttrValue.ListValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = TensorBoardS_AttrValue.protoMessageName + ".ListValue"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    2: .same(proto: "s"),
    3: .same(proto: "i"),
    4: .same(proto: "f"),
  ...
  static func ==(lhs: TensorBoardS_AttrValue.ListValue, rhs: TensorBoardS_AttrValue.ListValue) -> Bool {
...
extension TensorBoardS_NameAttrList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,TensorBoardS_AttrValue>.self, value: &self.attr)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.attr.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,TensorBoardS_AttrValue>.self, value: self.attr, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: TensorBoardS_NameAttrList, rhs: TensorBoardS_NameAttrList) -> Bool {
