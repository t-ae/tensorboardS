...
struct TensorBoardS_TensorProto {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var dtype: TensorBoardS_DataType {
    get {return _storage._dtype}
    set {_uniqueStorage()._dtype = newValue}
  }

  /// Shape of the tensor.  TODO(touts): sort out the 0-rank issues.
  var tensorShape: TensorBoardS_TensorShapeProto {
    get {return _storage._tensorShape ?? TensorBoardS_TensorShapeProto()}
  ...
  mutating func clearTensorShape() {_uniqueStorage()._tensorShape = nil}
  ...
  /// DT_RESOURCE
  var resourceHandleVal: [TensorBoardS_ResourceHandleProto] {
...
extension TensorBoardS_TensorProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _dtype: TensorBoardS_DataType = .dtInvalid
    var _tensorShape: TensorBoardS_TensorShapeProto? = nil
    ...
    var _resourceHandleVal: [TensorBoardS_ResourceHandleProto] = []
  ...
  static func ==(lhs: TensorBoardS_TensorProto, rhs: TensorBoardS_TensorProto) -> Bool {
