...
struct TensorBoardS_VersionDef {
...
extension TensorBoardS_VersionDef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TensorBoardS_VersionDef, rhs: TensorBoardS_VersionDef) -> Bool {
